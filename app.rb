...
get '/api/restaurants/filter' do
  ...
  result = JSON.parse(RestaurantsController.filter(filters))
  json result
end

# Bulk new create restaurants
post '/api/restaurants/bulk' do
  list = params['restaurants'] || []
  result = JSON.parse(RestaurantsController.bulk_create(list))
  json result
end

# Soft delete restaurants data
patch '/api/restaurants/:id/disable' do
  result = JSON.parse(RestaurantsController.soft_delete(params[:id]))
  json result
end
...
# To find Random Restaurant
get '/api/restaurants/random' do
  result = JSON.parse(RestaurantsController.random)
  json result
end
